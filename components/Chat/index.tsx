...
const Chat = ({ title, children, chatContainerRef,onWheel, onScroll, handleSendButtonClick, onClickScrollDown }: ChatProps) => {
    ...
    return (
        <>
            ...
            <div className={`flex flex-col z-2 grow p-10 gap-10 overflow-y-auto scroll-smooth scrollbar-none 2xl:p-6 md:p-5 !pb-0`}  ref={chatContainerRef} onWheel={onWheel} onScroll={onScroll}>
                {children}
