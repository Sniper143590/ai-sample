...
const Chat = ({ title, children, chatContainerRef,onWheel, onScroll }: ChatProps) => {
    ...
    return (
        <>
            ...
            <div className={`relative z-2 grow p-10 space-y-10 overflow-y-auto scroll-smooth scrollbar-none 2xl:p-6 md:p-5 !pb-[160px]`}  ref={chatContainerRef} onWheel={onWheel} onScroll={onScroll}>
                {children}
            </div>
            <ModalShareChat
