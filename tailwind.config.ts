  ...
  plugins: [
    ...
    plugin(function ({ addBase, addComponents, addUtilities }:any) {
        ...
        addComponents({
            ...
            ".btn-white": {
                "@apply btn bg-n-1 border-n-3 shadow-[0_0.125rem_0.25rem_rgba(0,0,0,0.15)] text-n-7 fill-n-7 hover:bg-n-2 dark:bg-n-6 dark:border-n-1/10 dark:text-n-1 dark:fill-n-1 dark:hover:bg-n-1/10":
                    {},
            },
            ".btn-stroke-dark": {
                "@apply btn text-n-1 hover:bg-n-3 dark:hover:bg-n-5 border-n-4 dark:border-n-4": {},
            },
            ".btn-stroke-light": {
            ...
            ".btn-normal": { 
                "@apply h-9 rounded-md bg-n-1 hover:bg-n-3 dark:hover:bg-n-6 border-n-4 dark:border-n-4 dark:text-n-3 dark:bg-n-5": {},
            },
            ".btn-medium": {
                "@apply h-10": {},
            },
