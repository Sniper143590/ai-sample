...
const updatePromptContext = async (moduleIndex:number, promptContext:string) => {
  try {
    ...
    if (docToUpdate) {
        await updateDoc(docToUpdate, {
            prompt_context: promptContext // Replace "fieldName" with the actual field name and "NewValue" with the new value you want to set
        });
...
export default updatePromptContext
